...
export default ({ getModel, setGetModel, getShipment }) => {
   ...
   return getModel ? (
       <div className= "fixed inset-0 z-10 overflow-y-auto">
           ...
           ></div>
           <div className="flex items-enter min-h-screen px-4 py-8">
                   ...
                   <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                       ...
                       <form onSubmit={(e) => e.preventDefault()}>
                           ...
                           <button
                              ...
                              className="block w-full mt-3 py-3 px4 font-medium text-sm text-center text-white bg-indigo-600 hover:big-indigo-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2"
                           >
                               Get details
                               </button> 
                       </form>
                       ...
                       {singleShipmentData == undefined ? (
                           ...
                           <div className="text-left">
                               ...
                               <p>DeliveryTime: {convertTime(singleShipmentData.pickTime)}</p>
